  ...
  $.extend(Tipswift.prototype, {
    show: function(content, options) {
      ...
      if (!this.shown && this.enabled) {
        ...
        ov.find('.tipswift-inner').remove().end()
          ...
          .get(0).className = 'tipswift';
        this.setPosition(options);
        ov.addClass('tipswift-' + this.gravity).addClass(options.extraClass.join(' '));
    ...
    getPositionner: function(options) {
      ...
      return function() {
        ...
        options.showEffect.call(self.getOverlay(), options, self.gravity);
        self.getOverlay().stop(true, true);
      };
    },
