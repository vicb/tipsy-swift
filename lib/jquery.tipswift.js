...
(function($) {
  ...
  $.extend(Tipswift.prototype, {
    ...
    showTip: function(delayIn) {
      if (!this.dialogOpened) {
        ...
        else
        {
          ...
          this.showTimer = null;
          var content = this.getTipContent();
          if (content && this.enabled) {
            o.showEffect.call(this.buildDom(content, 'tip'), o, this.gravity);
            this.tipOpened = true;
          }
        }
      }
    ...
    showDialog: function() {
      ...
      if (this.enabled) {
        var o = this.dialogOptions, content = this.getDialogContent();
        o.showEffect.call(this.buildDom(content, 'dialog'), o, this.gravity);
     ...
     */
    buildDom: function(content, type)
    {
    ...
    getDialogContent: function() {
      return $.fn.tipSwift.templates.dialog(this.options.dialog, this.getButtonsContent());
    },
     ...
     * @api private
     */
    getButtonsContent: function() {
      var id, buf = '';
      var buttons = $.isFunction(this.options.dialog.buttons)?this.options.dialog.buttons():this.options.dialog.buttons;
  ...
  $.fn.tipSwift = function(options) {
    ...
    var hasTip = typeof options.tip != 'undefined',
      ...
      options = $.extend(true, {}, $.fn.tipSwift.defaults, options)
